...
%% start Q_learning
ql = Q_learning(states, actions, alpha, gama, epsilon);
try
    for epi = 1:1:episode_num
        ...
        while 1
            ...
            action_to_take = ql.getEpsilonAction(current_state);
            ...
            fprintf('[Reward] %.2f \n', reward);
            %===========================================
            ql = ql.updateLearn(current_state, state_prime, action_to_take, reward);
            if done
                break;
            end
